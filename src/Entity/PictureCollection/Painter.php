...
#[ORM\Entity(repositoryClass: PainterRepository::class)]
class Painter
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: Painting::class, mappedBy: 'painter', orphanRemoval: true)]
