...
class CleanVideosCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $progress = new ProgressBar($section1, $size);
        $progress->start();
        ...
        $progress = new ProgressBar($section3, $size);
        $progress->start();
